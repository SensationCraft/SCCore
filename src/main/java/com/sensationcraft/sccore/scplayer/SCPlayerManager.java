...
public class SCPlayerManager implements Listener {
    ...
    public void onPlayerMove(final PlayerMoveEvent e) {
        ...
        if (arenaManager != null) {
            if (arenaManager.getArena().isRunning() && arenaManager.getArena().getArenaPlayers().contains(player))
                return;
        }
    ...
    public void onPlayerDamageByPlayer(final EntityDamageByEntityEvent e) {
        ...
        if (faction.getName().equalsIgnoreCase("Safezone") && !(arenaManager.getArena().getArenaPlayers().contains(player) || arenaManager.getArena().getArenaPlayers().contains(target))) {
            return;
        }
