...
public class KickCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String command, String[] args) {
		...
		if (hover) {
			...
			message = message.then(senderSCPlayer.getTag()).tooltip(senderSCPlayer.getHoverText()).then(" has kicked ").color(ChatColor.GRAY)
			...
			message = message.then("Console").color(ChatColor.GOLD).then(" has kicked ").color(ChatColor.GRAY).then(scPlayer.getTag()).tooltip(scPlayer.getHoverText())
