...
import com.sensationcraft.sccore.xrayspy.commands.XraySpyCommand;
...
public class SCCore extends JavaPlugin implements Listener {
    ...
    public void onDisable() {
        ...
        for (UUID uuid : scPlayerManager.getScPlayers().keySet()) this.scPlayerManager.removeSCPlayer(uuid);
    ...
    public void registerEvents() {
        ...
        pm.registerEvents(xrayManager, this);
