...
public final class Reflection {
    ...
    public synchronized static String getVersion() {
        if (Reflection._versionString == null) {
            ...
            Reflection._versionString = name.substring(name.lastIndexOf('.') + 1) + ".";
        }
    ...
    public synchronized static Method getMethod(Class<?> clazz, String name,
        ...
        Map<String, Map<ArrayWrapper<Class<?>>, Method>> loadedMethodNames = Reflection._loadedMethods.get(clazz);
