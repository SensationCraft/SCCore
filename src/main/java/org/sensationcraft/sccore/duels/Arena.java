...
public class Arena {
	...
	protected void endMatch(final Player loser) {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				Location location = winner.equals(Arena.this.primaryPlayer) ? Arena.this.primaryPlayerLocation : Arena.this.secondaryPlayerLocation;
	...
	public void forceEnd() {
		...
		this.primaryPlayer.teleport(this.primaryPlayerLocation);
		this.secondaryPlayer.teleport(this.secondaryPlayerLocation);
